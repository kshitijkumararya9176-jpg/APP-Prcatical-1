...
r1 = Report("Advanced Python Practical Report", "Kshitij Arya")
...
r1.add_content("Report prepared by Kshitij Arya.")
...
r2 = Report("Employee Performance Report", "Kshitij Arya")
...
r3 = Report("Student Result Report", "Kshitij Arya")
